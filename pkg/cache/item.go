...
// Copied from https://raw.githubusercontent.com/coredns/coredns/refs/heads/master/plugin/cache/item.go
...
func (i *item) matches(qname string, qtype uint16) bool {
	if qtype == i.QType && strings.EqualFold(qname, i.Name) {
		return true
	}
	return false
}
